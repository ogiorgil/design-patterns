...
public class SweetsMonitorTest {
    ...
    public void testSweetsMonitorNotifyRoadUsersMethod(){
        ...
        doNothing().when(newCourierA).handleNotification("Sweets Monitor", "Jakarta");
        doNothing().when(newCourierB).handleNotification("Sweets Monitor", "Jakarta");
        doNothing().when(newHunterA).handleNotification("Sweets Monitor", "Jakarta");
        ...
        verify(newCourierA, times(1))
                .handleNotification("Sweets Monitor", "Jakarta");
