...
public class DragoMonitorTest {
    ...
    public void testDragoMonitorNotifyRoadUsersMethod(){
        ...
        doNothing().when(newCourierA).handleNotification("Drago Monitor", "Jakarta");
        doNothing().when(newCourierB).handleNotification("Drago Monitor", "Jakarta");
        doNothing().when(newHunterA).handleNotification("Drago Monitor", "Jakarta");
        ...
        verify(newCourierA, times(1))
                .handleNotification("Drago Monitor", "Jakarta");
